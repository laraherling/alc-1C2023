...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 22 10:50:12 2023
...
predicciones_promedio = lista_predicciones_promedio(matriz_promedios, test_reducido)
...
precision_promedios = precision(test_reducido, predicciones_promedio)
print(precision_promedios)
...
e = errores(test_reducido, predicciones_promedio)

#Ejemplo de error 1
imagen(46, test_reducido)
pred_1 = prediccion(matriz_promedios, test_reducido, 46)
print(pred_1)

#Ejemplo de error 2
imagen(18, test_reducido)
pred_2 = prediccion(matriz_promedios, test_reducido, 18)
print(pred_2)

#Ejemplo de error 3
imagen(38, test_reducido)
pred_3 = prediccion(matriz_promedios, test_reducido, 38)
print(pred_3)
...
predicciones_k1 = lista_predicciones_U(matrices_U, test_reducido, 1)
errores_k1 = errores(test_reducido, predicciones_k1) #longitud = 46

predicciones_k2 = lista_predicciones_U(matrices_U, test_reducido, 2)
errores_k2 = errores(test_reducido, predicciones_k2) #logitud = 26

predicciones_k3 = lista_predicciones_U(matrices_U, test_reducido, 3)
errores_k3 = errores(test_reducido, predicciones_k3) #longitud = 16

predicciones_k4 = lista_predicciones_U(matrices_U, test_reducido, 4)
errores_k4 = errores(test_reducido, predicciones_k4) #longitud = 11

predicciones_k5 = lista_predicciones_U(matrices_U, test_reducido, 5)
errores_k5 = errores(test_reducido, predicciones_k5) #longitud = 11

#Observamos que, si bien la cantidad de errores fue la misma, con k=4 y k=5 
#la predicción no falló en las mismas imágenes. 


#Con k=1 la prediccion sobre la fila 8 es errónea, mientras que con k=4 no
imagen(11, test_reducido)
